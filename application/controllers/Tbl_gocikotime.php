...
// 		'hari' => $row->hari,
    ...
    public function create() 
    {
	    ...
	    'playtime_mp3' => set_value('playtime_mp3'),
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // get judul lagu berdasarkan kode_mp3
            $get_kode_mp3 = $this->input->post('kode_mp3',TRUE);
            $sql = "select judul from tbl_mp3 where kode_mp3 = $get_kode_mp3";
            ...
            $data = array(
                        ...
                        'playtime_mp3' =>$this->input->post('playtime_mp3',TRUE),
                        'judul_mp3' =>$get_judul,
    ...
    public function update($id) 
    {
		...
		'playtime_mp3' => set_value('playtime_mp3', $row->playtime_mp3),
...
// 		'hari' => set_value('hari', $row->hari),
	...
	$this->form_validation->set_rules('kode_mp3', 'kode_mp3', 'trim|required');
	$this->form_validation->set_rules('playtime_mp3', 'playtime_mp3', 'trim|required');
