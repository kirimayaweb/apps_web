...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- KIRIMAYA Desain List Start -->
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-0 gx-5 align-items-end">
                    <div class="col-lg-12">
                        <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                            <h1 class="mb-12">Silahkan PILIH DESAIN RENCANA Hunian Idaman Anda</h1>
                ...
                <div class="row g-0 gx-5 align-items-end">
                    ...
                    <!-- <p>Pilih Lokasi yang anda Inginkan.</p> -->
                        <ul class="nav nav-pills d-inline-flex justify-content-end mb-5">
                            ...
                            <?php
                                $start=0;
                                foreach ($data_desain_all_group as $data_property_all_group_kota_list)
                                {
                            ?>
                                <li class="nav-item me-2">
                                    <a class="btn btn-outline-primary" data-bs-toggle="pill" href="#tab-<?php echo $data_property_all_group_kota_list->group_desain ?>"><?php echo $data_property_all_group_kota_list->group_desain ?></a>
                                </li>
                            <?php
                                }
                            ?>
                ...
                <div class="tab-content">
                    <div id="tab-all" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <?php
                                $start=0;
                                foreach ($data_desain_all as $data_property_all_list)
                                {                                
                                    ?>
                                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="property-item rounded overflow-hidden">
                                                <div class="position-relative overflow-hidden">
                                                    <a href=""><img class="img-fluid" src="<?php echo base_url("assets/DESAIN/".$data_property_all_list->poto) ?>" alt=""></a>
                                                    
                                                    <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">
                                                        <?php echo $data_property_all_list->group_desain ?>
                                                    </div>
                                                    
                                                    <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3"><?php echo $data_property_all_list->nama_desain ?></div>
                                                </div>
                                                <div class="p-4 pb-0">
                                                    <h5 class="text-primary mb-3"><?php echo "Rp. " . nominal($data_property_all_list->harga)  ?></h5>
                                                    <a class="d-block h5 mb-2" href=""><?php echo "Desain: " . $data_property_all_list->group_desain . " , Model: " . $data_property_all_list->model ?></a>
                                                ...
                                                <div class="d-flex border-top">
                                                    <small class="flex-fill text-center py-2">
                                                        <div class="col-12 text-center">
                                                            <a class="btn btn-primary py-3 px-5" href="Desain_proses/Proses_beli_pilih/<?php echo $data_property_all_list->uuid?>">Beli</a>
                                                            <?php 
                    ...
                    <?php
                        ...
                        {
                        ?>
                        <div id="tab-<?php echo $data_property_all_group_kota_list->group_desain ?>" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <?php
                                    $start=0;
                                    foreach ($data_desain_all as $data_property_all_list)
                                    {
                                        if ($data_property_all_list->group_desain == $data_property_all_group_kota_list->group_desain )
                                        {
                                        ...
                                        ?>
                                            ...
                                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                                <div class="property-item rounded overflow-hidden">
                                                    <div class="position-relative overflow-hidden">
                                                        <a href=""><img class="img-fluid" src="<?php echo base_url("assets/DESAIN/".$data_property_all_list->poto) ?>" alt=""></a>
                                                        <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3"><?php echo $data_property_all_list->group_desain ?></div>
                                                        <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3"><?php echo $data_property_all_list->nama_desain ?></div>
                                                    </div>
                                                    <div class="p-4 pb-0">
                                                        <h5 class="text-primary mb-3"><?php echo "Rp. " . nominal($data_property_all_list->harga)  ?></h5>
