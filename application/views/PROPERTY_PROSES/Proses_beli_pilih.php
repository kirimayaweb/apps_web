    ...
    <div class="container-xxl project py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h3 class="display-5 mb-12">Silahkan Lanjutkan proses pembelian hunian idaman anda.</h3>
            </div>
            <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-lg-4">
                    ...
                    <?php
                        $start = 0;
                        foreach ($data_property_terpilih as $list_data)
                        {
                            $x_nomor=++$start;
                ...
                <div class="col-lg-8">
                    ...
                    <!-- Appointment Start -->
                    <form action="<?php echo base_url('Property_proses/Checkout_action/'.$uuid_hunian); ?>" method="post"><table class='table table-bordered'></table>
