    ...
    <div class="container-xxl project py-5">
        <div class="container">
            ...
            <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <!-- Appointment Start -->
                    <form action="<?php echo base_url(); ?>" method="post"><table class='table table-bordered'></table>
                        <div class="container-xxl py-5">
                            <div class="container">
                                <div class="row g-5">
                                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                                        <h4 class="section-title">CheckOut</h4>
                                        <h1 class="display-5 mb-4">Terimakasih</h1>
                                        <p class="mb-4">Selamat anda telah memproses pesanan hunian, silahkan cek whatsapp untuk konfirmasi detail & informasi pembayaran selanjutnya</p>
                                        <div class="col-4"></div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        Designed By <a href="https://gocikosukses.com/GRIYAKU">Griyaku</a>
                    </div>
                </div>
            </div>
        </div>
