    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>Griyaku</b> Apps</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <?php echo anchor('Auth/web_griyaku', '<i class="" aria-hidden="true"></i> Website Griyaku', array('class' => 'btn btn-success btn-block btn-flat')); ?>
                    </div>
                </div>
                <!-- /.col -->
