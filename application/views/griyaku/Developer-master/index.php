...
<html lang="en-us">
    <head>
        ...
        <!-- stylesheet -->
        <link rel="stylesheet" href="<?php echo $link_assets; ?>css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo $link_assets; ?>css/font-awesome.min.css">
        <link rel="stylesheet" href="<?php echo $link_assets; ?>css/owl.carousel.css">
		<link rel="stylesheet" href="<?php echo $link_assets; ?>css/owl.theme.min.css">
        <link rel="stylesheet" href="<?php echo $link_assets; ?>css/animate.css">
		<link rel="stylesheet" href="<?php echo $link_assets; ?>css/main.css">
    ...
    <body>
            ...
            <div class="isotope portfolio-items">
                <div class="element-item grid">
                    <div class="effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work1.jpg">
                        <figcaption>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work2.jpg">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work3.png">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work7.jpg">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work8.png">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work4.jpg">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work5.jpg">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="element-item grid">
                    <div class="portfolio-item effect-zoe">
                        <img class="img-responsive" alt="Portfolio" src="<?php echo $link_assets; ?>img/work6.jpg">
                        <figcaption>
                            <h2 class="hidden-xs">Creative <span>Joe</span></h2>
                            <p class="icon-links">
                                <a href="#"><i class="fa fa-twitter"></i></a>
       ...
       <!--  <div class="content-block text-center" id="services">
                        	...
                        	<div class="owl-carousel">
								<div class="owl-item">
									<div class="testimonial">
                                        <img alt="Client Photo" src="<?php echo $link_assets; ?>img/testimonial_31-190x190.jpg">
								...
								<div class="owl-item">
									<div class="testimonial">
                                        <img alt="Client Photo" src="<?php echo $link_assets; ?>img/testimonial_11-190x190.jpg">
                                        <p>In at accumsan risus. Nam id volutpat ante. Etiam vel mi mattis, vulputate nunc nec, sodales nibh. Etiam nulla magna, gravida eget ultricies sit amet.</p>
								...
								<div class="owl-item">
									<div class="testimonial">
                                        <img alt="Client Photo" src="<?php echo $link_assets; ?>img/testimonial_22-190x190.jpg">
                                        <p>In at accumsan risus. Nam id volutpat ante. Etiam vel mi mattis, vulputate nunc nec, sodales nibh. Etiam nulla magna, gravida eget ultricies sit amet.</p>
        ...
        <script src="<?php echo $link_assets; ?>js/jquery-2.1.3.min.js"></script>
        <script src="<?php echo $link_assets; ?>js/bootstrap.min.js"></script>
        <script src="<?php echo $link_assets; ?>js/jquery.actual.min.js"></script>
        <script src="<?php echo $link_assets; ?>js/isotope.pkgd.min.js"></script>
        <script src="<?php echo $link_assets; ?>js/owl.carousel.min.js"></script>
        <script src="<?php echo $link_assets; ?>js/jquery.isonscreen.js"></script>
