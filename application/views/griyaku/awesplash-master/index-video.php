...
<html lang="en">
    <head>
        ...
        <!-- CSS -->
        <link href="<?php echo $link_assets; ?>assets/css/jquery.mb.YTPlayer.min.css" rel="stylesheet">
        <link href="<?php echo $link_assets; ?>assets/css/jquery.mb.vimeo_player.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <!-- JS -->
        <script src="<?php echo $link_assets; ?>assets/js/plugins/jquery.mb.YTPlayer.min.js"></script>
        <script src="<?php echo $link_assets; ?>assets/js/plugins/jquery.mb.vimeo_player.min.js"></script>
