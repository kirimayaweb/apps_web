...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="<?php echo $link_assets; ?>css/vendor.css">
    <link rel="stylesheet" href="<?php echo $link_assets; ?>css/styles.css">

    <!-- favicons
    ================================================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $link_assets; ?>apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo $link_assets; ?>favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo $link_assets; ?>favicon-16x16.png">
...
<body id="top">
                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="index.html">
                            <img src="<?php echo $link_assets; ?>images/logo.svg" alt="Homepage">
                        </a>
                    </div>
            ...
            <section id="folio" class="s-folio target-section">
                        ...
                        <div class="bricks-wrapper">
                            ...
                            <article class="brick brick--double entry">
                                <a href="#modal-01" class="entry__link">
                                    <div class="entry__thumb">
                                        <img src="<?php echo $link_assets; ?>images/folio/white_turban@2x.jpg" alt="">
                                    </div>
                            ...
                            <article class="brick brick--double entry">
                                <a href="#modal-02" class="entry__link">
                                    <div class="entry__thumb">
                                        <img src="<?php echo $link_assets; ?>images/folio/caffeine_and_tulips@2x.jpg" alt="">
                                    </div>
                                    <div class="entry__info">
                            ...
                            <article class="brick entry">
                                <a href="#modal-03" class="entry__link">
                                    <div class="entry__thumb">
                                        <img src="<?php echo $link_assets; ?>images/folio/grayscale@2x.jpg" alt="">
                                    </div>
                                    <div class="entry__info">
                            ...
                            <article class="brick entry">
                                <a href="#modal-04" class="entry__link">
                                    <div class="entry__thumb">
                                        <img src="<?php echo $link_assets; ?>images/folio/lamp@2x.jpg" alt="">
                                    </div>
                                    <div class="entry__info">
                            ...
                            <article class="brick entry">
                                <a href="#modal-05" class="entry__link">
                                    <div class="entry__thumb">
                                        <img src="<?php echo $link_assets; ?>images/folio/tropical@2x.jpg" alt="">
                                    </div>
                                    <div class="entry__info">
                                        <div class="entry__cat">Frontend Design</div>
                            ...
                            <article class="brick entry">
                                <a href="#modal-06" class="entry__link">
                                    <div class="entry__thumb">
                                        <img src="<?php echo $link_assets; ?>images/folio/woodcraft@2x.jpg" alt="">
                                    </div>
                                    <div class="entry__info">
                                        <div class="entry__cat">E-Commerce</div>
                ...
                <div id="modal-01" hidden>
                    <div class="modal-popup">
                        <img src="<?php echo $link_assets; ?>images/folio/gallery/g-turban.jpg" alt="">
                ...
                <div id="modal-02" hidden>
                    <div class="modal-popup">
                        <img src="<?php echo $link_assets; ?>images/folio/gallery/g-tulips.jpg" alt="">
                ...
                <div id="modal-03" hidden>
                    <div class="modal-popup">
                        <img src="<?php echo $link_assets; ?>images/folio/gallery/g-grayscale.jpg" alt="">
                ...
                <div id="modal-04" hidden>
                    <div class="modal-popup">
                        <img src="<?php echo $link_assets; ?>images/folio/gallery/g-lamp.jpg" alt="">
                ...
                <div id="modal-05" hidden>
                    <div class="modal-popup">
                        ...
                        <img src="<?php echo $link_assets; ?>images/folio/gallery/g-tropical.jpg" alt="">
                ...
                <div id="modal-06" hidden>
                    <div class="modal-popup">
                        <img src="<?php echo $link_assets; ?>images/folio/gallery/g-woodcraft.jpg" alt="">
                    ...
                    <div class="column lg-12">
                        ...
                        <div class="row clients-list block-lg-one-fourth block-md-one-third block-tab-one-half block-stack">
                            ...
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/snowflake.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/flash.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/rise.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/pinpoint.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/proline.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/vision.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/volume.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="<?php echo $link_assets; ?>images/clients/hitech.svg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="<?php echo $link_assets; ?>images/avatars/user-02.jpg" alt="Author image" class="s-testimonials__avatar">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="<?php echo $link_assets; ?>images/avatars/user-03.jpg" alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="<?php echo $link_assets; ?>images/avatars/user-01.jpg" alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="<?php echo $link_assets; ?>images/avatars/user-06.jpg" alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
    ...
    <!-- Java Script
    ================================================== -->
    <script src="<?php echo $link_assets; ?>js/plugins.js"></script>
