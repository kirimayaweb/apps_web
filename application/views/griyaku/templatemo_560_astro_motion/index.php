...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $link_assets; ?>css/slick.css" type="text/css" /> 
    <link rel="stylesheet" href="<?php echo $link_assets; ?>css/templatemo-style.css">
<!--
...
<body>
    <video autoplay muted loop id="bg-video">
        <source src="<?php echo $link_assets; ?>video/gfp-astro-timelapse.mp4" type="video/mp4">
    </video>
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                ...
                <div class="intro-right">
                  <img src="<?php echo $link_assets; ?>img/home-img-1.jpg" alt="Image" class="img-fluid intro-img-1">
                  <img src="<?php echo $link_assets; ?>img/home-img-2.jpg" alt="Image" class="img-fluid intro-img-2">
                </div>
            ...
            <div class="mx-auto position-relative gallery-container">
              ...
              <div class="mx-auto tm-border-top gallery-slider">
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-01.jpg" alt="Image">
                    <figcaption>
                        <div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-02.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-03.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-04.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-05.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-06.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-07.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-08.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                    <img src="<?php echo $link_assets; ?>img/gallery-img-09.jpg" alt="Image">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
  ...
  <script src="<?php echo $link_assets; ?>js/jquery-3.5.1.min.js"></script>
  <script src="<?php echo $link_assets; ?>js/bootstrap.min.js"></script>
  <script src="<?php echo $link_assets; ?>js/slick.js"></script>
  <script src="<?php echo $link_assets; ?>js/templatemo-script.js"></script>
</body>
</html>
