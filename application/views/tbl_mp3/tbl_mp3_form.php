	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA TBL_MP3</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td width='200'>Kode Mp3 <?php echo form_error('kode_mp3') ?></td><td><input type="text" class="form-control" name="kode_mp3" id="kode_mp3" placeholder="Kode Mp3" value="<?php echo $kode_mp3; ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('tbl_mp3') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
