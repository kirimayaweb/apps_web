...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url() ?>assets/adminlte/dist/css/skins/_all-skins.min.css">
          ...
          <!-- Date Picker -->
        <!-- Date Picker -->
        <!-- <link rel="stylesheet" href="<?php //echo base_url() ?>assets/AdminLTE-2.3.3/plugins/datepicker/datepicker3.css"> -->
        <!-- Daterange picker -->
        <!-- <link rel="stylesheet" href="<?php //echo base_url() ?>assets/AdminLTE-2.3.3/plugins/daterangepicker/daterangepicker-bs3.css"> -->
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>adminlte/index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>go ci</b>ko</span>
                </a>
