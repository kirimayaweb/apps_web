...
<body>
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-1 wow fadeIn" data-wow-delay="0.1s">
    ...
    <!-- Carousel Start -->
    <div class="container-fluid p-0 pb-1 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" data-dot="<img src='<?php echo base_url("assets/template_architecture-html-template/") ?>img/carousel-1.jpg'>">
                <img class="img-fluid" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/carousel-1.jpg" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="display-1 text-white animated slideInDown">Best Architecture And Interior Design Services</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-3">Ciri khas rumah dengan desain modern yakni memiliki bentuk atap yang unik dan tidak biasa, warna cat dinding yang minimalis serta memiliki balkon untuk bersantai.</p>
                                <a href="<?php echo base_url("Property_proses") ?>" class="btn btn-primary py-3 px-5 animated slideInLeft">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="owl-carousel-item position-relative" data-dot="<img src='<?php echo base_url("assets/template_architecture-html-template/") ?>img/carousel-2.jpg'>">
                <img class="img-fluid" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/carousel-2.jpg" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="display-1 text-white animated slideInDown">Best Architecture And Interior Design Services</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-3">Untuk mengetahui sebuah hunian itu menggunakan konsep smart house atau idak, kamu setidaknya harus masuk ke ruangan interiornya terlebih dahulu. <br/> Sebab yang menjadi ciri khas sebuah smart house adalah penggunaan peralatannya yang sudah berbasis teknologi.</p>
                                <a href="<?php echo base_url("Property_proses") ?>" class="btn btn-primary py-3 px-5 animated slideInLeft">Read More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='<?php echo base_url("assets/template_architecture-html-template/") ?>img/carousel-3.jpg'>">
                <img class="img-fluid" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/carousel-3.jpg" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-2.png" alt="Icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-3.png" alt="Icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                        <div class="fact-icon">
                            <img src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-4.png" alt="Icon">
                        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/service-1.jpg" alt="">
                        <div class="service-text p-5">
                            <img class="mb-4" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-5.png" alt="Icon">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/service-2.jpg" alt="">
                        <div class="service-text p-5">
                            <img class="mb-4" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-6.png" alt="Icon">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/service-3.jpg" alt="">
                        <div class="service-text p-5">
                            <img class="mb-4" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-7.png" alt="Icon">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/service-4.jpg" alt="">
                        <div class="service-text p-5">
                            <img class="mb-4" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-8.png" alt="Icon">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/service-5.jpg" alt="">
                        <div class="service-text p-5">
                            <img class="mb-4" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-9.png" alt="Icon">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        <img class="bg-img" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/service-6.jpg" alt="">
                        <div class="service-text p-5">
                            <img class="mb-4" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/icons/icon-10.png" alt="Icon">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100" src="<?php echo base_url("assets/template_architecture-html-template/") ?>img/project-1.jpg"
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='<?php echo base_url("assets/template_architecture-html-template/") ?>img/testimonial-1.jpg' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                    <h3>Client Name</h3>
                    <span class="text-primary">Profession</span>
                </div>
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='<?php echo base_url("assets/template_architecture-html-template/") ?>img/testimonial-2.jpg' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                    <h3>Client Name</h3>
                    <span class="text-primary">Profession</span>
                </div>
                <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='<?php echo base_url("assets/template_architecture-html-template/") ?>img/testimonial-3.jpg' alt=''>">
                    <p class="fs-5">Clita clita tempor justo dolor ipsum amet kasd amet duo justo duo duo labore sed sed. Magna ut diam sit et amet stet eos sed clita erat magna elitr erat sit sit erat at rebum justo sea clita.</p>
                    <h3>Client Name</h3>
                    <span class="text-primary">Profession</span>
                </div>
