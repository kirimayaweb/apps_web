...
<head>
    <meta charset="utf-8">
    <title>kirimaya -  Construction Company Website Template Free</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/favicon.ico" rel="icon">
...
<body>
            ...
            <div class="col-lg-4 text-center py-3">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-start">
                        ...
                        <span>Solo - Jateng - indonesia</span>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid sticky-top bg-dark bg-light-radial shadow-sm px-5 pe-lg-0">
        <nav class="navbar navbar-expand-lg bg-dark bg-light-radial navbar-dark py-3 py-lg-0">
            <a href="index.html" class="navbar-brand">
                <h1 class="m-0 display-4 text-uppercase text-white"><i class="bi bi-building text-primary me-2"></i>kirimaya</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a href="<?php echo base_url("Template3/") ?>index" class="nav-item nav-link active">Home</a>
                    <a href="<?php echo base_url("Template3/") ?>about" class="nav-item nav-link">About</a>
                    <a href="<?php echo base_url("Template3/") ?>service" class="nav-item nav-link">Service</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu m-0">
                            <a href="<?php echo base_url("Template3/") ?>project" class="dropdown-item">Our Project</a>
                            <a href="<?php echo base_url("Template3/") ?>team" class="dropdown-item">The Team</a>
                            <a href="<?php echo base_url("Template3/") ?>testimonial" class="dropdown-item">Testimonial</a>
                            <a href="<?php echo base_url("Template3/") ?>blog" class="dropdown-item">Blog Grid</a>
                            <a href="<?php echo base_url("Template3/") ?>detail" class="dropdown-item">Blog Detail</a>
                        </div>
                    </div>
                    <a href="<?php echo base_url("Template3/") ?>contact" class="nav-item nav-link">Contact</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="<?php echo base_url("Property_proses") ?>" class="nav-item nav-link bg-primary text-white px-5 ms-3 d-none d-lg-block">Pesan Rumah / Hunian <i class="bi bi-arrow-right"></i></a>
                </div>
            </div>
        </nav>
    </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="<?php echo base_url("Property_proses") ?>" class="btn btn-primary py-md-3 px-md-5 mt-2">Get A Quote</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <img src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/signature.jpg" alt="">
            </div>
            <div class="col-lg-5 pb-5" style="min-height: 400px;">
                <div class="position-relative bg-dark-radial h-100 ms-5">
                    <img class="position-absolute w-100 h-100 mt-5 ms-n5" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/about.jpg" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white d-flex flex-column align-items-center text-center">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/service-1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/service-2.jpg" alt="">
                    <div class="service-icon bg-white">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/service-3.jpg" alt="">
                    <div class="service-icon bg-white">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/service-4.jpg" alt="">
                    <div class="service-icon bg-white">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/service-5.jpg" alt="">
                    <div class="service-icon bg-white">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-white rounded d-flex flex-column align-items-center text-center">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/service-6.jpg" alt="">
                    <div class="service-icon bg-white">
                ...
                <div class="d-inline-block bg-dark-radial text-center pt-4 px-5 mb-5">
                    <ul class="list-inline mb-0" id="portfolio-flters">
                        <li class="btn btn-outline-primary bg-white p-2 active mx-2 mb-4" data-filter="*">
                            <img src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/portfolio-1.jpg" style="width: 150px; height: 100px;">
        ...
        <div class="row g-5">
                ...
                <div class="row g-0">
                    <div class="col-10" style="min-height: 300px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/team-1.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-2">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    <div class="col-10" style="min-height: 300px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/team-2.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="h-100 d-flex flex-column align-items-center justify-content-between bg-light">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    <div class="col-10" style="min-height: 300px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/team-3.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="h-100 d-flex flex-column align-items-center justify-content-between bg-light">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="row g-0">
                    <div class="col-10" style="min-height: 300px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/team-4.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="h-100 d-flex flex-column align-items-center justify-content-between bg-light">
    ...
    <div class="container-fluid bg-light py-6 px-5">
        ...
        <div class="row gx-0 align-items-center">
            <div class="col-xl-4 col-lg-5 d-none d-lg-block">
                <img class="img-fluid w-100 h-100" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/testimonial.jpg">
            </div>
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="row gx-4 align-items-center">
                            <div class="col-xl-4 col-lg-5 col-md-5">
                                <img class="img-fluid w-100 h-100 bg-light p-lg-3 mb-4 mb-md-0" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/testimonial-1.jpg" alt="">
                            </div>
                        ...
                        <div class="row gx-4 align-items-center">
                            <div class="col-xl-4 col-lg-5 col-md-5">
                                <img class="img-fluid w-100 h-100 bg-light p-lg-3 mb-4 mb-md-0" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/testimonial-2.jpg" alt="">
                            </div>
                            <div class="col-xl-8 col-lg-7 col-md-7">
                                <h4 class="text-uppercase mb-0">Client Name</h4>
                                <p>Profession</p>
    ...
    <div class="container-fluid py-6 px-5">
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="bg-light">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/blog-1.jpg" alt="">
                    <div class="p-4">
                        <div class="d-flex justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle me-2" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/user.jpg" width="35" height="35" alt="">
                                <span>John Doe</span>
                            </div>
                            <div class="d-flex align-items-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/blog-2.jpg" alt="">
                    <div class="p-4">
                        <div class="d-flex justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle me-2" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/user.jpg" width="35" height="35" alt="">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="bg-light">
                    <img class="img-fluid" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/blog-3.jpg" alt="">
                    <div class="p-4">
                        <div class="d-flex justify-content-between mb-4">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle me-2" src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>img/user.jpg" width="35" height="35" alt="">
    ...
    <div class="footer container-fluid position-relative bg-dark bg-light-radial text-white-50 py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-6 pe-lg-5">
                ...
                <p><i class="fa fa-map-marker-alt me-2"></i>Solo - Jateng - indonesia</p>
                <p><i class="fa fa-phone-alt me-2"></i>+012 345 67890</p>
                <p><i class="fa fa-envelope me-2"></i>info@kirimaya.id</p>
    ...
    <div class="container-fluid bg-dark bg-light-radial text-white border-top border-primary px-0">
        <div class="d-flex flex-column flex-md-row justify-content-between">
            <div class="py-4 px-5 text-center text-md-start">
                <p class="mb-0">&copy; <a class="text-primary" href="#">kirimaya.id</a>. All Rights Reserved.</p>
            </div>
            <div class="py-4 px-5 bg-primary footer-shape position-relative text-center text-md-end">
                <p class="mb-0">Designed by <a class="text-dark" href="https://gocikosukses.com/kirimaya">kirimaya</a></p>
            </div>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>js/jquery-3.4.1.min.js"></script>
    <!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script> -->
    <script src="<?php echo base_url("assets/template_construction-company-website-template-free/") ?>js/bootstrap.bundle.min.js"></script>
